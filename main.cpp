...
int main()
{
	...
	int fact_check;
	cout << "Xin chao!" << endl;
	cout << "Day co phai lan dau su dung dich vu ATM cua ban khong? Chon 1 neu co. Chon 0 neu khong phai: ";
	cin >> fact_check;
	if (fact_check == 1)
	{
		createAcc();
		cout << "Ban da tao duoc tai khoan moi. Xin vui long khoi dong lai chuong trinh.";
		return -1;
	}
	else
	{
